...
5. [Qwen3 VL Embedding 模型](#5-qwen3-vl-embedding-模型)
6. [模型对比与选择](#6-模型对比与选择)
7. [配置与使用](#7-配置与使用)
...
| qwen3-vl-embedding-8b | 4096 | 阿里云 | 多模态、图文理解 |
...
## 5. Qwen3 VL Embedding 模型

### 5.1 模型介绍

Qwen3-VL-Embedding-8B 是阿里云通义千问团队开发的多模态嵌入模型，支持图像和文本的联合理解。
...
| qwen3-vl-embedding-8b | 4096 | ~16KB | ~160MB | ~16GB |
### 6.3 选择指南
